	...
	jQuery(document).ready(function(){
		...
		jQuery("#btnCreate").click(function(){
			...
			if(confirm("Proses DO yang Terpilih Untuk Dijadikan Tagihan?")){
                ...
                jQuery("#deskripsi").val("Franco <?php echo date("d/m/y",strtotime($filter["RSTRDJ_FROM"]))?> - <?php echo date("d/m/y",strtotime($filter["RSTRDJ_TO"]))?>") ;
	                ...
	                <div class="portlet-body">
                        ...
                        <div>
                        	<div class="input-group">
                                ...
                                <input type="hidden" class="form-control" placeholder="Deskripsi" maxlength="30" name="url_from" id="url_from" value="Franco"> 
                            </div>
                            <br>
							<div class="input-group">
