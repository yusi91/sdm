var Login = function() {
    var e = function() {
        ...
        s = function() {
            function e(e) {
                ...
                var r = $('<span><img src="<?php echo base_url(); ?>assets/global/img/flags/' + e.element.value.toLowerCase() + '.png" class="img-flag" /> ' + e.text + "</span>");
                return r
            }
    ...
    return {
        init: function() {
            e(), r(), s(), $.backstretch(["<?php echo base_url(); ?>assets/pages/media/bg/1.jpg", "<?php echo base_url(); ?>assets/pages/media/bg/2.jpg", "<?php echo base_url(); ?>assets/pages/media/bg/3.jpg", "<?php echo base_url(); ?>assets/pages/media/bg/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
